...
const Footer = () => {
    return (
        <footer className=" bg-slate-300 dark:bg-gray-900  mt-60">
        <div className="container p-6 mx-auto">
            <div className="lg:flex">
                <div className="w-full -mx-6 lg:w-2/5">
                    <div className="px-6">
                        ...
                        <p className="max-w-sm mt-2 text-gray-500 dark:text-gray-400 text-left">Join 31,000+ other and never miss out on new tips, tutorials, and more.</p>
            ...
            <div>
                <p className="text-center text-gray-500 dark:text-gray-400">© BigOne 2020 - All rights reserved</p>
            </div>
        </div>
    </footer>
    );
